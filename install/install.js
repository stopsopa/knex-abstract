...
const createIgnoreFilter = (ignorefile, root) => {
  ...
  var ignoretool = (function () {
    ...
    const t = /^\s+$/,
      ...
      i = /^\\#/,
      s = '/',
      n = 'undefined' != typeof Symbol ? Symbol.for('node-ignore') : 'node-ignore',
      o = (e, t, r) => Object.defineProperty(e, t, {value: r}),
      c = /([0-z])-([0-z])/g,
      a = [
        [/\\?\s+$/, (e) => (0 === e.indexOf('\\') ? ' ' : '')],
        [/\\\s/g, () => ' '],
        ...
        [
          ...
          (e, t, r) =>
            ']' === r
              ? `[${((e) => e.replace(c, (e, t, r) => (t.charCodeAt(0) <= r.charCodeAt(0) ? e : '')))(t)}]`
              : `\\${e}`,
        ],
        [/(?!\\)\?/g, () => '[^/]'],
        [/^\//, () => '^'],
      ...
      l = [...a, [/(?:[^*])$/, (e) => `${e}(?=$|\\/$)`], ...h],
      u = {},
      _ = (e) => e && 'string' == typeof e && !t.test(e) && 0 !== e.indexOf('#'),
      f = (e, t) => {
        const s = e;
        let n = !1;
        return (
          ...
          {
            origin: s,
            pattern: (e = e.replace(r, '!').replace(i, '#')),
            negative: n,
            regex: ((e, t, r) => {
              const i = u[e];
              if (i) return i;
              const s = (t ? l : d).reduce((t, r) => t.replace(r[0], r[1].bind(e)), e);
              return (u[e] = r ? new RegExp(s, 'i') : new RegExp(s));
            })(e, n, t),
          }
        );
      };
    class g {
      constructor({ignorecase: e = !0} = {}) {
        (this._rules = []), (this._ignorecase = e), o(this, n, !0), this._initCache();
      }
      _initCache() {
        this._cache = {};
      }
      add(t) {
        return (
          (this._added = !1),
          'string' == typeof t && (t = t.split(/\r?\n/g)),
          e(t).forEach(this._addPattern, this),
      ...
      _addPattern(e) {
        if (e && e[n]) return (this._rules = this._rules.concat(e._rules)), void (this._added = !0);
        if (_(e)) {
          const t = f(e, this._ignorecase);
          (this._added = !0), this._rules.push(t);
        }
      }
      filter(t) {
        return e(t).filter((e) => this._filter(e));
      }
      createFilter() {
      ...
      _filter(e, t) {
        return (
          ...
          (e in this._cache
            ...
            : (t || (t = e.split(s)),
              t.pop(),
              (this._cache[e] = t.length ? this._filter(t.join(s) + s, t) && this._test(e) : this._test(e))))
        );
      }
      _test(e) {
        let t = 0;
        return (
          this._rules.forEach((r) => {
            t ^ r.negative || (t = r.negative ^ r.regex.test(e));
          }),
          !t
        );
      }
    ...
    if (
      ...
      const e = g.prototype._filter,
        t = (e) => (/^\\\\\?\\/.test(e) || /[^\x00-\x80]+/.test(e) ? e : e.replace(/\\/g, '/'));
      g.prototype._filter = function (r, i) {
        return (r = t(r)), e.call(this, r, i);
      };
    }
    return (e) => new g(e);
  })();
...
const installTool = (source, target, filter) =>
...
(function () {
  ...
  let list = [
    ...
    l.filter = createIgnoreFilter(path.resolve(l.source, '.installgnore'), l.source);
  ...
  allChain([
    ...
    () =>
      installTool(
        path.resolve(source, 'migrations', 'ormconfig.js.mysql'),
        path.resolve(project, 'migrations', 'ormconfig.js'),
        () => true
      ),
